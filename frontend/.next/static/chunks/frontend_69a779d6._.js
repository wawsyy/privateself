...
"[project]/frontend/app/error-suppress.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ErrorSuppress() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ErrorSuppress.useEffect": ()=>{
            ...
            const handleError = {
                "ErrorSuppress.useEffect.handleError": (event)=>{
            ...
            }["ErrorSuppress.useEffect.handleError"];
            // Global unhandled rejection handler
            const handleRejection = {
                "ErrorSuppress.useEffect.handleRejection": (event)=>{
                    var _event_reason;
                    const errorMessage = ((_event_reason = event.reason) === null || _event_reason === void 0 ? void 0 : _event_reason.message) || String(event.reason) || String(event);
                    if (errorMessage.includes("Failed to fetch") || errorMessage.includes("fetch")) {
                        event.preventDefault();
                        return false;
                    }
                }
            }["ErrorSuppress.useEffect.handleRejection"];
...
_s(ErrorSuppress, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = ErrorSuppress;
var _c;
__turbopack_context__.k.register(_c, "ErrorSuppress");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=frontend_69a779d6._.js.map