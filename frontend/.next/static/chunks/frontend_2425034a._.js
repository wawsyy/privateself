...
_s(useDreamJournal, "lO6wuyIMQcon4BetRBMJPqThV4A=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
const DreamJournalDemo = ()=>{
    ...
    const lastDebugRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])("");
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DreamJournalDemo.useEffect": ()=>{
            if (isConnected) {
                const debugKey = "".concat(chainId, "-").concat(fhevmStatus, "-").concat(!!eip1193Provider, "-").concat(!!ethersSigner);
...
_s(DreamJournalDemo, "yPo2wwn6qlB/FmdKMXySFVCWqAA=", false, function() {
    return [
